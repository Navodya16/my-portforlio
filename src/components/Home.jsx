      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center px-4 md:flex-row">
        <div className="flex flex-col justify-center ">
          <h2 className="text-4xl sm:text-7xl font-bold text-white">
            Hi! I'm Navodya Rathnasekara
          </h2>
          <p className="text-gray-500 py-4 max-w-md">
            I am a Computer Engineering graduate at the University of Sri
            Jayewardenepura, with solid foundation in software development, and
            have demonstrated excellence in both individual and collaborative
            projects, with technical skills as well as interpersonal skills. I
            am dedicated to achieving excellence in all endeavors I undertake
            whether independently or as part of a team.
          </p>
          <div>
            <Link
              to="Experience"
